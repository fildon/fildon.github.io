...
description: Implement flexible function APIs with default options using TypeScript's Partial type and destructuring patterns.
date: 2022-10-24
...
// This works!
format("default formatted message", {});
// Also works!
...
format("A plain default message");
format("Formatting still works too", {
	color: "blue",
	fontWeight: "light",
});
```
